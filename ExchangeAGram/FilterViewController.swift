...
class FilterViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        // This code creates a queue so the app runs smoother (fake multi-threading)
    ...
    func filterImageFromImage (imageData: NSData, filter: CIFilter) -> UIImage {
        ...
        // This bit of code makes the app faster by giving the images a default size
    ...
    // MARK: - UI Alert Controller helper functions
    ...
    func createUIAlertController(indexPath: NSIndexPath) {
        ...
        let cancelAction = UIAlertAction(title: "Select another file", style: UIAlertActionStyle.Cancel) { (UIAlertAction) -> Void in
        }
    ...
    func saveFilterToCoreData (indexPath: NSIndexPath, caption: String) {
        let filterImage = self.filterImageFromImage(thisFeedItem.image, filter: self.filters[indexPath.row])
